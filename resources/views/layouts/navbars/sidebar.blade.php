...
{{--                        <img alt="Image placeholder" src="{{ asset('argon') }}/img/theme/team-1-800x800.jpg">--}}
        ...
        <!-- Collapse -->
        <div class="collapse navbar-collapse" id="sidenav-collapse-main fixed-right">
            <!-- Collapse header -->
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-examples" data-toggle="collapse" role="button"
                       aria-expanded="true" aria-controls="navbar-examples">
                        ...
                        <span class="nav-link-text" style="color: #f4645f;">{{ __('Account') }}</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-examples2" data-toggle="collapse" role="button"
                       aria-expanded="true" aria-controls="navbar-examples2">
                        <i class="fa fa-building-o" style="color: #f4645f;"></i>
                        <span class="nav-link-text" style="color: #f4645f;">{{ __('Organization') }}</span>
                    </a>
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('project') }}">
                                    <i class="fa fa-database" data-icon="mdi-briefcase-check" style="color: #f4645f;"></i>
                                    {{ __('Projects') }}
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('servers') }}">
                                    <i class="fas fa-server text-blue" data-icon="mdi-briefcase-check" style="color: #f4645f;"></i>
                                    {{ __('Servers') }}
                                </a>
                            </li>
                        </ul>
